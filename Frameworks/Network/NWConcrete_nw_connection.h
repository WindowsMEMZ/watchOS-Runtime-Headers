...
@class NSString;
@protocol OS_dispatch_data, OS_dispatch_group, OS_dispatch_queue, OS_dispatch_workloop, OS_nw_array;
...
@interface NWConcrete_nw_connection : NSObject<OS_nw_connection> {
  ...
  struct nw_connection_throughput_monitor_s { unsigned long long current_bytes; unsigned long long current_time; unsigned long long last_bytes; unsigned long long last_time; void *timer; unsigned int minimum; unsigned char x[4] __pad; } throughput_monitor;
