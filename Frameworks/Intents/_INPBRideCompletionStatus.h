...
@interface _INPBRideCompletionStatus : PBCodable<_INPBRideCompletionStatus, NSSecureCoding, NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 canceled; unsigned int x :1 canceledByService; unsigned int x :1 completed; unsigned int x :1 missedPickup; unsigned int x :1 outstanding; } _has;
}
