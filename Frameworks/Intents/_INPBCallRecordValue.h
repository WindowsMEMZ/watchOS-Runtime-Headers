...
@interface _INPBCallRecordValue : PBCodable<_INPBCallRecordValue, NSSecureCoding, NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 callCapability; unsigned int x :1 callType; unsigned int x :1 isCallerIdBlocked; unsigned int x :1 preferredCallProvider; unsigned int x :1 unseen; } _has;
}
