...
@interface _INPBPayloadUnsupported : PBCodable<_INPBPayloadUnsupported, NSSecureCoding, NSCopying> {
  /* instance variables */
  struct { unsigned int x :1 updateAlarmIntentAlarmUnsupportedReason; unsigned int x :1 changeAlarmStatusIntentAlarmsUnsupportedReason; unsigned int x :1 deleteAlarmIntentAlarmsUnsupportedReason; unsigned int x :1 searchAlarmIntentAlarmsUnsupportedReason; unsigned int x :1 snoozeAlarmIntentAlarmsUnsupportedReason; unsigned int x :1 sendAnnouncementIntentAnnouncementUnsupportedReason; unsigned int x :1 startCallIntentCallCapabilityUnsupportedReason; unsigned int x :1 startCallIntentCallRecordToCallBackUnsupportedReason; unsigned int x :1 addTasksIntentContactEventTriggerUnsupportedReason; unsigned int x :1 setTaskAttributeIntentContactEventTriggerUnsupportedReason; unsigned int x :1 startCallIntentContactsUnsupportedReason; unsigned int x :1 requestPaymentIntentCurrencyAmountUnsupportedReason; unsigned int x :1 sendPaymentIntentCurrencyAmountUnsupportedReason; unsigned int x :1 customUnsupportedReason; unsigned int x :1 dateTimeRangeUnsupportedReason; unsigned int x :1 findDeviceAndPlaySoundIntentDeviceUnsupportedReason; unsigned int x :1 joinCallIntentGroupConversationUnsupportedReason; unsigned int x :1 reportIncidentIntentIncidentTypeUnsupportedReason; unsigned int x :1 createTimerIntentLabelUnsupportedReason; unsigned int x :1 addMediaIntentMediaDestinationUnsupportedReason; unsigned int x :1 addMediaIntentMediaItemsUnsupportedReason; unsigned int x :1 playMediaIntentMediaItemsUnsupportedReason; unsigned int x :1 searchForMediaIntentMediaItemsUnsupportedReason; unsigned int x :1 updateMediaAffinityIntentMediaItemsUnsupportedReason; unsigned int x :1 participantUnsupportedReason; unsigned int x :1 addCallParticipantIntentParticipantsUnsupportedReason; unsigned int x :1 sendPaymentIntentPayeeUnsupportedReason; unsigned int x :1 requestPaymentIntentPayerUnsupportedReason; unsigned int x :1 playMediaIntentPlaybackSpeedUnsupportedReason; unsigned int x :1 startCallIntentPreferredCallProviderUnsupportedReason; unsigned int x :1 reason; unsigned int x :1 shareETAIntentRecipientUnsupportedReason; unsigned int x :1 stopShareETAIntentRecipientUnsupportedReason; unsigned int x :1 sendMessageIntentRecipientUnsupportedReason; unsigned int x :1 sendAnnouncementIntentRecipientsUnsupportedReason; unsigned int x :1 saveHealthSampleIntentRecordDateUnsupportedReason; unsigned int x :1 targetEventUnsupportedReason; unsigned int x :1 addTasksIntentTargetTaskListMembersUnsupportedReason; unsigned int x :1 setTimerAttributeIntentTargetTimerUnsupportedReason; unsigned int x :1 deleteTasksIntentTaskListUnsupportedReason; unsigned int x :1 deleteTasksIntentTaskUnsupportedReason; unsigned int x :1 snoozeTasksIntentTaskUnsupportedReason; unsigned int x :1 addTasksIntentTemporalEventTriggerUnsupportedReason; unsigned int x :1 setTaskAttributeIntentTemporalEventTriggerUnsupportedReason; unsigned int x :1 runWorkflowIntentWorkflowUnsupportedReason; } _has;
}
