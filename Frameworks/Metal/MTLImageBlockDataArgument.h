...
/* instance methods */
- (id)initWithName:(id)name type:(unsigned long long)type access:(unsigned long long)access isActive:(BOOL)active index:(unsigned long long)index dataSize:(unsigned int)size masterStructMembers:(id)members aliasImplicitImageBlock:(BOOL)block aliasImplicitImageBlockRenderTarget:(unsigned int)target;
- (void)dealloc;
