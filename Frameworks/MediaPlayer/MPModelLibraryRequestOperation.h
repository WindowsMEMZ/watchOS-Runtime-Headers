...
- (void)_insertPropertyCacheForEntityPID:(long long)pid entityClass:(void *)class entityTranslator:(id)translator translationContext:(id)context propertyCachesVector:(const void *)vector;
- (id)_itemProperties;
- (id)_libraryView;
