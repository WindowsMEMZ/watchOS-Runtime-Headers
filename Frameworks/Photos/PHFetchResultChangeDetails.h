...
/* instance methods */
- (id)initWithFetchResult:(id)result currentFetchResult:(id)result changedIdentifiers:(id)identifiers unknownMergeEvent:(BOOL)event;
- (id)initWithFetchResult:(id)result currentFetchResult:(id)result sortedChangedIdentifiers:(id)identifiers unknownMergeEvent:(BOOL)event;
