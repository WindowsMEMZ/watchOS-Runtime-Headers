...
//
#ifndef SPInterfaceActivityRingView_h
#define SPInterfaceActivityRingView_h
@import Foundation;
...
@property (retain, nonatomic) HKActivityRingView *hkRingView;
...
#endif /* SPInterfaceActivityRingView_h */
