...
/* class methods */
+ (void)readAttributeDefaultOTAProvidersWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
+ (void)readAttributeUpdatePossibleWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
+ (void)readAttributeUpdateStateWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
+ (void)readAttributeUpdateStateProgressWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
- (void)announceOTAProviderWithParams:(id)params completion:(id /* block */)completion;
- (void)readAttributeDefaultOTAProvidersWithParams:(id)params completion:(id /* block */)completion;
- (void)writeAttributeDefaultOTAProvidersWithValue:(id)value completion:(id /* block */)completion;
- (void)writeAttributeDefaultOTAProvidersWithValue:(id)value params:(id)params completion:(id /* block */)completion;
- (void)subscribeAttributeDefaultOTAProvidersWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)readAttributeUpdatePossibleWithCompletion:(id /* block */)completion;
- (void)subscribeAttributeUpdatePossibleWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)readAttributeUpdateStateWithCompletion:(id /* block */)completion;
- (void)subscribeAttributeUpdateStateWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)readAttributeUpdateStateProgressWithCompletion:(id /* block */)completion;
- (void)subscribeAttributeUpdateStateProgressWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
