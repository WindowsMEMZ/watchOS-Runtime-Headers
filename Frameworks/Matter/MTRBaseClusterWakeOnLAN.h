...
/* class methods */
+ (void)readAttributeMACAddressWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
- (void)readAttributeMACAddressWithCompletion:(id /* block */)completion;
- (void)subscribeAttributeMACAddressWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
