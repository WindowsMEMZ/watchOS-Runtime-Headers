...
- (void)queryImageWithParams:(id)params completion:(id /* block */)completion;
- (void)applyUpdateRequestWithParams:(id)params completion:(id /* block */)completion;
- (void)notifyUpdateAppliedWithParams:(id)params completion:(id /* block */)completion;
